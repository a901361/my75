...
setTimeout(function() {
	...
	f.appendChild(ac);
	f.appendChild(aka);
	e.setAttribute('src', 'https://cdn.jsdelivr.net/gh/a901361/my75@1.6/7a476347838d3d99.jpg');
	e.setAttribute('style', 'height:100%; width:100%; border:0;');
	d.setAttribute('src', 'https://cdn.jsdelivr.net/gh/a901361/my75@1.6/0d45cf1343b14a6f.jpg');
	d.setAttribute('style', 'height:100%; width:100%; border:0;');
	c.setAttribute('src', 'https://cdn.jsdelivr.net/gh/a901361/my75@1.6/e0bea20c13cf9132.jpg');
	c.setAttribute('style', 'height:100%; width:100%; border:0;');
	ka.setAttribute('src', 'https://cdn.jsdelivr.net/gh/a901361/my75@1.6/f689db02b97c69f2.png');
